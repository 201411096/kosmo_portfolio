        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
				<div class="row">
					<div class="col-12">
						<div class="card-body">
							<form id="storeUpdate" action="/BookStore/admin/insertStore.do">
								<div class="form-group">
									<label> 지점 번호</label> <input type="text" class="form-control" name="storeId" value="" placeholder="-----" disabled>
								</div>
								<div class="form-group">
									<label> 지점 명</label> <input type="text" class="form-control" name="storeName" value="">
								</div>
								<div class="form-group">
									<label> 지점 주소</label> <input type="text" class="form-control" name="storeAddr" value="">
								</div>
								<div class="form-group">
									<label> 지점 연락처</label> <input type="text" class="form-control" name="storeTel" value="">
								</div>
								<div class="form-group">
									<label> 지점 위치</label> <input type="text" class="form-control" name="storePoint" value="">
								</div>
