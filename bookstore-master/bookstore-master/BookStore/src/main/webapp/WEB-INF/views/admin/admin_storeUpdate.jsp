        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
				<div class="row">
					<div class="col-12">
						<div class="card-body">
							<form id="storeUpdate" action="/BookStore/admin/storeUpdatePage.do">
								<div class="form-group">
									<label> 지점 번호</label> <input type="text" class="form-control" name="storeId" value="${storevo.storeId}" readonly>
								</div>
								<div class="form-group">
									<label> 지점 명</label> <input type="text" class="form-control" name="storeName" value="${storevo.storeName}">
								</div>
								<div class="form-group">
									<label> 주소</label> <input type="text" class="form-control" name="storeAddr" value="${storevo.storeAddr}">
								</div>
								<div class="form-group">
									<label> 연락처</label> <input type="text" class="form-control" name="storeTel" value="${storevo.storeTel}">
								</div>
								<div class="form-group">
									<label> 위치</label> <input type="text" class="form-control" name="storePoint" value="${storevo.storePoint}">
								</div>
